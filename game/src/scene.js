...
export class Scene {
  ...
  buildScene(){
    ...
    this.ballTween = gsap.to(  this.ballTweenObject, { y: 0, z: .7, duration: .3, repeat: -1, yoyo: true, ease: "sine.expo"});
      ...
      this.stadium.traverse( ( object ) =>  {
        ...
        if(object.material!==undefined){
          ...
          if(object.material.name==="lowerFence"){
            ...
            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0xbf4240, map: this.saveMat});
            ...
            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0x3c5667, map: this.saveMat});
  
          }else if(object.material.name==="roof"){

            this.roof = object;
            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0x6f8b8a, map: this.saveMat});
  
          }else if(object.material.name==="roofBars"){

            this.roofBars = object;
            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0x7e7f81});
  
          }else if(object.material.name==="roofBarsInner"){

            this.roofBarsInner = object;

            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0x2c2c2b});
  
          }else if(object.material.name==="roofWall"){

            this.roofWall = object;
            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0x2d2e39});
            ...
            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0xd4d4d3});
  
          }else if(object.material.name==="glintLight"){

            this.roofWall = object;
            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0xffffff, fog: false});
  
          }else if(object.material.name==="lineLight"){

            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0xffffff, transparent: true, fog: false, map: this.saveMat});
  
          }else if(object.material.name==="rig"){

            this.rig = object;
            object.material = new THREE.MeshBasicMaterial({ wireframe: false, color: 0x171717});
  
          }else if(object.material.name==="jumbotron"){

            object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0xffffff, fog: false, map: this.saveMat});
  
          }else if(object.material.name==="jumboOutline"){

            object.material = new THREE.MeshBasicMaterial({ wireframe: false, color: 0x999999});
        ...
        if(object.name.substring(0,7)==="s_light"){
            ...
            this.planeGeo = new THREE.PlaneGeometry( .005, .005 );
            this.planeMat = new THREE.MeshStandardMaterial({color: "red", visible: false});
        ...
        if(object.name==="top"){
          ...
          object.material = new THREE.MeshStandardMaterial({ wireframe: false, color: 0x0e1a1a});
          this.seats = object;
          ...
          object.material = new THREE.MeshBasicMaterial({ wireframe: false, color: 0xffffff, map: this.saveMat, fog: false, side: THREE.DoubleSided});
  ...
  resetBoard(){
    ...
    for(var i = 0; i<this.pellets.length; i++){
      ...
      this.pellets[i].scale.x = this.pellets[i].scale.y = this.pellets[i].scale.z = .6;
  ...
  makePellet(z, x){
    ...
    this.pellet.scale.x = this.pellet.scale.y = this.pellet.scale.x = .6;
  ...
  controlRings(){
    ...
    for(var i=0; i<this.pellets.length; i++){
      ...
      if( box1.intersectsBox(box2)===true && this.pellets[i].action==="ready"){
        ...
        gsap.to(  this.pellets[i].scale, { x: 0, y: 0, z: 0, duration: .2, ease: "sine.out"});
  ...
  makePoleLine(z, delay){
    ...
    for(var i=-6; i<6; i++){
      ...
      this.pole.scale.x = this.pole.scale.y = this.pole.scale.z = .5;

      this.poleCont.add( this.pole );

    }

    gsap.to(  this.poleCont.position, { x: this.poleCont.position.x+4, duration: 2, delay: delay, repeat: -1, yoyo: true, ease: "sine.inOut"});
          ...
          for(var j=0; j<g.gates.length; j++){
            ...
            if(g.state==="even"){
              ...
              if( j % 2 === 0 ){
                ...
                gsap.to(  g.gates[j].position, { y: 0, duration: .2, ease: "sine.out"});
      
              }else{
      
                gsap.to(  g.gates[j].position, { y: -5, duration: .2, ease: "sine.out"});
  ...
  makeSpinner(x,z){
    ...
    this.spinner.scale.x = this.spinner.scale.y = this.spinner.scale.z = .6
  ...
  update(){
    ...
    if(this.action==="set"){
      ...
      this.ball.position.x=this.playerCont.position.x-.22 + (this.xspeed*.02)
      this.ball.position.y=.22 + this.ballTweenObject.y
      this.ball.position.z=this.playerCont.position.z + .5 + this.ballTweenObject.z
  ...
  mixer(){
    ...
    if(document.getElementById("mix").checked === true){
        ...
        document.getElementById("c1_Color").value = this.hslToHex(c1_H,c1_S,c1_L);
        ...
        document.getElementById("c2_Color").value = this.hslToHex(c2_H,c2_S,c2_L);
        ...
        document.getElementById("c3_Color").value = this.hslToHex(c3_H,c3_S,c3_L);
        this.roofEdge.material.color.setHex( "0x"+this.hslToHex(c3_H,c3_S,c3_L) );
        ...
        document.getElementById("c4_Color").value = this.hslToHex(c4_H,c4_S,c4_L);
        ...
        document.getElementById("c5_Color").value = this.hslToHex(c5_H,c5_S,c5_L);
